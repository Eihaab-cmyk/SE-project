...
const CartItem = ({item, setFlag, flag}) => {
  ...
  return (
    ...
    <img
     src={item?.imageURL} className='w-20 h-20 max-w-[60px] rounded-full object-contain'
     alt="" 
    />
    ...
    <div className='flex flex-col gap-2'>
        ...
        <p className='text-sm block text-gray-300 font font-semibold'>${parseFloat(item?.price) * qty}</p>
    </div>

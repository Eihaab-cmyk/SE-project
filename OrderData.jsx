...
const OrderData = ({index, data, admin}) => {
  ...
  return (
    <motion.div {...staggerFadeInOut(index)} className=' w-full flex flex-col items-start justify-start px-3 py-2 border relative border-gray-300 bg-cardOverlay drop-shadow-md rounded-md gap-4'>
        <div className=' w-full flex items-center justify-between'>
            <h1 className=' text-xl text-headingColor font font-semibold'>Orders</h1>

            <div className=' flex items-center gap-4'>
                <p className=' flex items-center gap-1 text-textColor'>
                    Total: <BsCurrencyDollar className=' text-lg text-red-500' />{" "} <span className=' text-headingColor font-bold'>{data?.total}</span>
                </p>
                ...
                {admin && (
                    <div className=' flex items-center justify-center gap-2'>
                        ...
                        className={`text-orange-500 bg-orange-200 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                        >
                            Preparing
                        </motion.p>
                        ...
                        className={`text-red-500 bg-red-200 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                        >
                            Cancelled
                        </motion.p>
                        ...
                        className={`text-emerald-500 bg-emerald-200 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                        >
                            Delivered
                        </motion.p>
                    </div>
        ...
        <div className=' flex items-center justify-start flex-wrap w-full'>
            ...
            <div className=' flex items-start justify-start flex-col gap-2 px-2 ml-auto w-full md:w-460'>

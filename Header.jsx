...
import Logo from './drive-download-20230920T161113Z-001/logo.png'
import {MdAddShoppingCart, MdAdd, MdLogout} from "react-icons/md";
import Avatar from './drive-download-20230920T161113Z-001/avatar.png'
    ...
    <header className='fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16 bg-primary'>
      <div className='hidden md:flex w-full h-full item-center justify-between'>
        <Link to={"/"} className='flex items-center gap-2'>
          ...
          <p className='text-headingColor text-xl font-bold'>Foodora</p>
        </Link>
         ...
         <div className='relative'>
           ...
           />
           {
              isMenu && (
                ...
                right-0'>
                 {
                   user && user.email === "tsample942@gmail.com" && (
                     <Link to={"/createItem"}>

    ...
    <motion.div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='flex flex-col items-start justify-start gap-6'>
       ...
       <p className='text-base text-teal-50 text-center md:text-left md:w-[88%]'>
           Looking for the quickest delivery service around? You're in the right place! Our team is dedicated to providing you with a seamless and speedy experience. Say goodbye to long waits and hello to express deliveries that redefine convenience.
           <br/>
           <br />
           Why choose us?
           <br />
           <BsRocketTakeoff className='inline'/> Swift and Efficient service
           <br />
           <IoEarth className='inline' /> Wide coverage across the city
           <br />
           <BiShoppingBag className='inline' /> Shop with confidence, knowing your order is on the way
        </p> 
        <motion.button
         {...buttonClick}

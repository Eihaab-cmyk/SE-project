...
import { Avatar, Lo, Logo } from '../assets/img';
       ...
       <nav className='flex items-center justify-center gap-8'>
        ...
        {user ?
         <>
           <div className='relative cursor-pointer' onMouseEnter={() => setisMenu(true)}>
            ...
            {isMenu && (
                ...
                <Link className='hover:text-red-500 text-xl text-teal-50'
                to={"/dashboard/home"}
                >
                    Dashboard
                </Link>
         ...
         :
          <>
           <NavLink to={"/login"}>
            <motion.button {...buttonClick} className='px-4 py-2  text-teal-50 rounded-md bg-cardOverlay border border-red-300'>
                Login
            </motion.button>
           </NavLink>
        </>

  ...
  return (
    <div className='h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-210 w-300 gap-3'>
       ...
       <ul className='flex flex-col gap-4'>
            <NavLink className={({isActive}) => isActive ? `${isActiveStyles} px-4 py-2 border-l-8` : isNotActiveStyles} to={"/dashboard/home"} >Home</NavLink>
            <NavLink className={({isActive}) => isActive ? `${isActiveStyles} px-4 py-2 border-l-8` : isNotActiveStyles} to={"/dashboard/orders"} >Orders</NavLink>
       ...
       <div className='w-full items-center justify-center flex h-225 mt-auto px-2'>
        <div className='w-full h-full rounded-md bg-red-400 flex items-center justify-center flex-col gap-3 px-3'>
            ...
            <p className='text-base text-gray-300 text-center'>
                Having trouble in Foodora. Please contact us for more questions
            </p>
